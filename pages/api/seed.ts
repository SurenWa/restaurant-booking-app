    ...
    await prisma.restaurant.createMany({
        data: [
            ...
            // MEXICAN //
            {
                ...
                price: PRICE.REGULAR,
                description:
                    "Eldorado Taco restaurant is excited to serve you traditional Mexican cuisine, re-imagined with a distinct modern flair, in a stylish setting on Preston street. Striving to bring you some of Ottawaâ€™s best Tacos, margaritas and Tequila. Reserve your table now!",
                images: [
            ...
            },
            {
                ...
                price: PRICE.CHEAP,
                description:
                    "Specializing in the preparation of high quality Mexican food. Our vibrant dÃ©cor, carefully selected menu, great staff and exciting entertainment will ensure that you are treated to a unique dining experience.",
                images: [
            ...
            },
            {
                ...
                price: PRICE.REGULAR,
                description:
                    "Terroni Adelaideâ€™s multi-level location is located in Torontoâ€™s historic York County Court House circa 1853.",
                images: [
            ...
            },
            {
                ...
                price: PRICE.CHEAP,
                description:
                    "Ä“st is a modern, newly reopened restaurant serving Italian-French courses, captivating cocktails and wine.",
                images: [
    ...
    await prisma.item.createMany({
        data: [
            ...
            },
            {
                name: "Shahi Tukda",
                description:
                    "Chefâ€™s signature dessert : crispy bread poched with flavoured milk and topped with homemade cream made of pistachios, rose.",
                price: "$11.00",
                restaurant_id: vivaanId,
            },
            {
            ...
            },
            {
                ...
                description:
                    "Coconut crÃ©meux, chocolate hazelnut crunch, coconut snow, citrus gel, cardamom ice cream",
                price: "$19.00",
                restaurant_id: adrakYorkvilleId,
            },
            {
            ...
            },
            {
                ...
                description: "$32.00",
                price:
                    "Pan seared sea bream filet with sautÃ©ed leeks, served over a wild rice medley and greens",
                restaurant_id: laBartolaId,
            },
            {
            ...
            },
            {
                name: "Hamachi",
                description:
                    "Ponzu Ã  la truffe, truffe noire rÃ¢pÃ©e [Salmon Tataki, Truffle ponzu, Shaved black truffle]",
                price: "$24.00",
            ...
            },
            {
                ...
                description:
                    "PurÃ©e d'avocat, chili soja [Tuna Tartar, Avocado puree, Chili soy]",
                price: "$27.00",
                restaurant_id: canoRestaurantId,
            },
            {
    ...
    await prisma.review.createMany({
        data: [
            ...
            },
            {
                first_name: "Josh",
                last_name: "Allen",
                text: "Great food, great staff. You canâ€™t ask for much more from a restaurant.",
                rating: 5,
                restaurant_id: bluRistoranteId,
                user_id: userJosh.id,
            },
